...
namespace Meton.ViewModels
{
    public class InputBlockViewModel : ViewModel
    {
        ...
        public string PostTextLength { get; set; }
        ...
        private void Post()
        {
            this.model.Update(this.PostText).Subscribe(_ => _TestResult_ = "Tweeted!: " + _.Text);
        }
        #endregion

        #region _TestResult_変更通知プロパティ
        private string __TestResult_;

        public string _TestResult_
        {
            get
            { return __TestResult_; }
            set
            {
                if (__TestResult_ == value)
                    return;
                __TestResult_ = value;
                RaisePropertyChanged("_TestResult_");
            }
        }
        #endregion
    }
